...
<head>
    ...
    <title>Organizing With Annie | Professional that can help with organizing, </title>
...
<body>
    ...
    <header>
        <nav class="main-nav">
            <ul>
                ...
                <li><a href="#about" data-go="about">About</a>
                </li>
                <li><a href="#services" data-go="services">Services</a>
                </li>
                <li><a href="#testimonials" data-go="testimonials">Testimonials</a>
                </li>
                <li><a href="#contact" data-go="contact">Contact</a>
                </li>
            </ul>
        </nav>
    ...
    <div class="wrapper">
        ...
        <section data-section="home" class="hero">
            <h1 class="main-heading">Improving your space, time, and quality of life</h1>
        </section>
        ...
        <section class="services-section">
            ...
            <div class="service">
                <div class="container grid service-summary">
                    <div class="twelve columns">
                        ...
                        <!-- <button type="button" class="service-detail-trigger secondary small no-float base-margin" data-servicename="s1-detail">Read More</button> -->
                    </div>
                </div>
                <div id="s1-detail" class="full-width-container service-detail">
                    <div class="grid">
                        <div class="twelve columns">
                        </div>
                    </div>
            ...
            <div class="service">
                <div class="container grid service-summary">
                    <div class="twelve columns">
                        ...
                        <!-- <button type="button" class="service-detail-trigger secondary small no-float base-margin" data-servicename="s2-detail">Read More</button> -->
                    </div>
                </div>
                <div id="s2-detail" class="full-width-container service-detail"></div>
            </div>
            <!-- End Service 2 -->
            ...
            <div class="service">
                <div class="container grid service-summary">
                    <div class="twelve columns">
                        ...
                        <!-- <button type="button" class="service-detail-trigger secondary small no-float base-margin" data-servicename="s3-detail">Read More</button> -->
                    </div>
                </div>
                <div id="s3-detail" class="full-width-container service-detail"></div>
            </div>
            <!-- End Service 3 -->
            ...
            <div class="service">
                <div class="container grid service-summary">
                    <div class="twelve columns">
                        ...
                        Going away to college is can be an exciting and anxious time for both the student and the rest of their family.  With more than 5 years experience working in housing, on university campuses, I know just what each student needs and how to fit everything into their new, compact residence hall room.  I can also share ideas for a smooth transition when the student comes back to their childhood home to visit during school breaks.  
                        <!-- <button type="button" class="service-detail-trigger secondary small no-float base-margin" data-servicename="s3-detail">Read More</button> -->
                    </div>
                </div>
                <div id="s4-detail" class="full-width-container service-detail"></div>
            </div>
            <!-- End Service 4 -->
            ...
            <div class="service">
                ...
                <div id="s5-detail" class="full-width-container service-detail"></div>
            </div>
            <!-- End Service 5 -->
                    ...
                    <form name="contactform" action="contact.php" method="post">
                        <div class="grid">
                            <div class="five columns">
                                ...
                                <input type="text" name="question" class="req" placeholder="WHAT IS 9+5?" />
                            </div>
                            <div class="seven columns">
                                <textarea name="message" cols="1" rows="5" class="req" placeholder="YOUR MESSAGE"></textarea>
                            </div>
                            <button name="submit" class="submit primary right" type="submit">SEND</button>
                        </div>
                    </form>
                </div>
            </div>
